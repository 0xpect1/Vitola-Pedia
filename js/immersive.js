...
(function () {
  ...
  const DRINKS = [
    ...
    { label: 'Scotch',      emoji: '🥃', terms: ['scotch', 'single malt', 'islay', 'speyside', 'highland'] },
    { label: 'Rye',         emoji: '🥃', terms: ['rye', 'rye whiskey'] },
    { label: 'Irish Whiskey', emoji: '🥃', terms: ['irish whiskey', 'irish'] },
    { label: 'Japanese Whisky', emoji: '🥃', terms: ['japanese whisky'] },
    { label: 'Dark Rum',    emoji: '🍹', terms: ['dark rum', 'aged rum', 'demerara'] },
    { label: 'Spiced Rum',  emoji: '🍹', terms: ['spiced rum'] },
    { label: 'Cognac',     emoji: '🥂', terms: ['cognac', 'armagnac'] },
    { label: 'Tequila',    emoji: '🟡', terms: ['tequila'] },
    { label: 'Mezcal',     emoji: '🟡', terms: ['mezcal'] },
    { label: 'Port',       emoji: '🍷', terms: ['port', 'tawny port'] },
    { label: 'Sherry',     emoji: '🍷', terms: ['sherry', 'amontillado', 'oloroso'] },
    { label: 'Red Wine',   emoji: '🍷', terms: ['red wine', 'wine', 'malbec', 'cabernet', 'zinfandel', 'syrah'] },
    { label: 'Stout',      emoji: '🍺', terms: ['stout', 'porter', 'barrel-aged stout'] },
    { label: 'IPA',        emoji: '🍺', terms: ['ipa', 'pale ale'] },
    { label: 'Belgian Quad', emoji: '🍺', terms: ['belgian quad', 'quadrupel'] },
    { label: 'Espresso',   emoji: '☕', terms: ['espresso', 'coffee'] },
    { label: 'Cold Brew',  emoji: '☕', terms: ['cold brew', 'iced coffee'] },
    { label: 'Cuban Coffee', emoji: '☕', terms: ['cuban coffee', 'cortadito', 'cafe de olla'] },
    { label: 'Tea',        emoji: '🍵', terms: ['tea', 'chai', 'earl grey'] },
    { label: 'Dark Chocolate', emoji: '🍫', terms: ['dark chocolate', 'chocolate'] },
    { label: 'Aged Cheese',  emoji: '🧀', terms: ['aged cheese', 'cheddar', 'manchego', 'parmesan'] },
    { label: 'Grilled Meats', emoji: '🥩', terms: ['steak', 'grilled meats', 'bbq', 'barbecue'] },
    { label: 'Cola',       emoji: '🥤', terms: ['cola'] },
    { label: 'Ginger Beer', emoji: '🥤', terms: ['ginger beer'] },
  ];
